...
class Template extends MX_Controller {
    ...
    public function __construct() {
        ...
        $this->load->module('information');
        $this->load->model('mdl_information');
        $this->mdl_information->initialization_inf();
    }
...
//    }
    public function index() {
        ...
        //$data[]= Modules::run('bills/index');
        //Run page in template
        //$this->load->view('main', $data);
        //echo Modules::run('template/content', $data);
        echo Modules::run('bills/index',$data);
    }
    ...
    public function getAssets() {
        $data['css'] = array(
            ...
            //$this->AddAsset('css/bootstrap3-wysiwyg5-color.css'),
        ...
        $data['js'] = array(
            ...
            $this->AddAsset('Scripts/jquery.validate.js'),
            $this->AddAsset('Scripts/additional-methods.min.js'),
            $this->AddAsset('Scripts/plugins/tinymce/tinymce.min.js'),
