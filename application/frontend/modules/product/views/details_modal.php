...
//        $('.ImageFiles').attr('name', 'ImageFiles1[]');
        ...
        function setDefaultSubInfor(last_item) {
            last_item.find('input[type=file]').attr('name', 'ImageFiles' + sub_item + '[]').val('');
            last_item.find('.sQuantity').attr('name', 'Quantity' + sub_item).val('');
            last_item.find('.sOrigin').attr('name', 'Origin' + sub_item).val('');
            last_item.find('.sColor').attr('name', 'Color' + sub_item).val('');
            last_item.find('.sSize').attr('name', 'Size' + sub_item).val('');
