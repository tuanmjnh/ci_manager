                ...
                <div class="panel-body">
                    <table class="table-details infor-sub-item" align="center">
                        <tbody>
                            ...
                            <tr>
                                <th><?= LKEY::GET('BillsBuyByList') ?></th>
                                <td class="form-group">
                                    <textarea id="BillsBuyByList" name="BillsBuyByList" class="form-control" 
                                              placeholder="Nhập danh sách tên người bán hàng, mỗi tên cách nhau bằng dấu phẩy (,)"
                                              ><?= INFKEY::GET_VALUE('BillsBuyByList', '') ?></textarea>
                                </td>
                            </tr>
                        </tbody>
                    </table>
